...
var _followers = __webpack_require__(30);
...
var _shared = __webpack_require__(38);
...
var INPUT_FIELD_ID = 'username';
var SUBMIT_BTN_ID = 'get-followers';
var LIST_SELECTOR = '.results-block__list';
var MSG_CONTAINER_SELECTOR = '.messages__wrapper';
...
var Task = function () {
    ...
    _createClass(Task, [{
        ...
        value: function initialize() {
            this.validator = new _input2.default(INPUT_FIELD_ID);
            this.userService = new _user2.default(SUBMIT_BTN_ID, this.validator);
            this.followersList = new _followers2.default(LIST_SELECTOR);
            this.MsgLogger = new _message2.default(MSG_CONTAINER_SELECTOR);
        }
    }]);
...
var UserService = function () {
    function UserService(submitBtnId, validator) {
    ...
    _createClass(UserService, [{
        ...
        value: function submit(e) {
            ...
            if (this.validator.isValid()) {
                _axios2.default.get(this.followersApiUrl + this.validator.getValue()).then(function (response) {
        ...
        key: 'createResults',
        value: function createResults(response) {
        ...
        value: function successCallback(data) {
            var createListEvent = new CustomEvent('followers.create', { detail: data.results }),
        ...
        key: 'errorCallback',
        value: function errorCallback(data) {
            var showError = new CustomEvent('request.failed', { detail: data });
...
var Validator = function () {
    ...
    _createClass(Validator, [{
        ...
        key: 'toggleError',
        value: function toggleError(isValid) {
        ...
        value: function showError() {
            var error = document.getElementsByClassName(this.validationErrorClassName)[0];
            ...
            if (error) {
                ...
                newError.classList.add(this.validationErrorClassName);
...
var _followersList = __webpack_require__(40);
...
var FollowersList = function () {
    function FollowersList(listSelector) {
    ...
    _createClass(FollowersList, [{
        key: 'initialize',
        value: function initialize() {
            window.addEventListener('followers.create', this.renderList.bind(this));

            window.addEventListener('request.failed', this.removeList.bind(this));
        }
    }, {
        key: 'createList',
        ...
        value: function renderList(e) {
            ...
            var html = this.createList(e.detail);
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/sass-loader/lib/loader.js!./shared.scss", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/sass-loader/lib/loader.js!./shared.scss");
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/sass-loader/lib/loader.js!./followers-list.scss", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/sass-loader/lib/loader.js!./followers-list.scss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
// module
exports.push([module.i, ".results-block__list {\n  padding-left: 20px; }\n  .results-block__list li {\n    margin-bottom: 10px; }\n", ""]);
...
var MessageLogger = function () {
    function MessageLogger(selector) {
    ...
    _createClass(MessageLogger, [{
        key: 'initialize',
        value: function initialize() {
            window.addEventListener('request.failed', this.showErrorMsg.bind(this));

            window.addEventListener('request.success', this.removeMsg.bind(this));
        }
    }, {
        key: 'createErrorMsg',
        value: function createErrorMsg(msg) {
            return '<span class="message message--error">' + msg + '</span>';
        }
    }, {
        key: 'showErrorMsg',
        value: function showErrorMsg(e) {
            var error = e.detail,
